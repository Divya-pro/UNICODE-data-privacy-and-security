...
test_key = "f4eba54dab7b4cdcb34f13689beea128acdc8960c8ec4c929d0c9f85d2fa5c66" # 256-bit (64 character) hex key
int_test_key = hexToKey(test_key)
sbox = generateDynamicSbox(sboxOrig, int_test_key)
print "PreDefined Sbox : "
print (sboxOrig)

print "Generated Sbox : "
print(sbox)
